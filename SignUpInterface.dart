                ...
                child: Padding(
                  ...
                  child: Column(children: [
                    TextFormField(
                      validator: (val) {
                        if (val!.length > 30) {
                          return "لا يمكن ان يكون الاسم الاول اكبر من 30 حرف";
                        }
                        if (val.length < 2) {
                    ...
                    TextFormField(
                      validator: (val) {
                        if (val!.length > 30) {
                          return "لا يمكن ان يكون الاسم الثاني اكبر من 30 حرف";
                        }
                        if (val.length < 2) {
                    ...
                    TextFormField(keyboardType: TextInputType.emailAddress,
                      validator: (val) {
                        if (val!.length > 30) {
                          return "لا يمكن ان يكون الايميل  اكبر من 30 حرف";
                        }
                        if (val.length < 15) {
                          return "لا يمكن أن يكون الايميل  أصغر من 15 حرف ";
                        }
                        return null;
                      },
                      style: TextStyle(color: Colors.black),
                    ...
                    TextFormField(
                      validator: (val) {
                        if (val!.length > 30) {
                          return "لا يمكن ان تكون كلمة المرور اكبر من 30 حرف";
                        }
                        if (val.length < 8) {
                          return "لا يمكن أن تكون كلمة المرور أصغر من 8 حروف";
                        }
                        return null;
                      },
                      onChanged: (password) {
